    ...
    <header id="header">
      <nav>
        <div class="navbar">
          ...
          /></a>
          <ul class="navigation">
            <li><a href="/kgk_v2/infiniti">Home</a></li>
          </ul>
        </div>
      </nav>
    </header>
    <div class="thanku" style="height: 80vh">
      <div class="thanku-background">
        <div class="thankustatement">
          ...
          <div>
          <a
              href="https://www.kgkrealty.com/wp-content/uploads/2020/10/KGK-Infiniti-Homes-E-Brochure-2.pdf"
              type="button"
            ...
            <div class="col-md-4">
              ...
              <p style="margin-top: 0" class="text-white">
                ...
                <a
                  ...
                  class="text-white text-decoration-none"
                  ><i class="fa fa-mobile" aria-hidden="true"></i>+91 7230 800 700</a
                >
                <br />
                <a
